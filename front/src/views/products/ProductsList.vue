...
export default {
  ...
  methods: {
     ...
     */
    onClickEditButton() {
      this.$router.push({ name: "productsEdit", query: { productCode: this.selectedRow.product_code } });
    },
     ...
     */
    onClickDeleteButton() {
      this.$router.push({ name: "productsDelete", query: { productCode: this.selectedRow.product_code } });
    },
  },
};
</script>
